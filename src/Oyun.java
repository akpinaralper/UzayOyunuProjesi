...
public class Oyun extends  JPanel implements KeyListener,ActionListener{
    ...
    public Oyun() {
        try {
            image = ImageIO.read(new File("src/uzaygemisi.png"));
    ...
    public void paint(Graphics g) {
        ...
        if (kontrolEt()) {
            timer.stop();
            double gecenSureSaniye = gecenSure / 1000.0; // Toplam süreyi saniye cinsinden hesapla
            String message = "Hedef vuruldu...\n"
                    + "Harcanan Ateş: " + harcananAtes + "\n"
                    + "Geçen süre: " + gecenSureSaniye + " saniye";
